...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--loadSize_1', type=int, default=304, help='scale images to this size')
        parser.add_argument('--loadSize_2', type=int, default=228, help='scale images to this size')
        parser.add_argument('--fineSize_1', type=int, default=304, help='then crop to this size')
        parser.add_argument('--fineSize_2', type=int, default=228, help='then crop to this size')
